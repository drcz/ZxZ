...
{S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_GUN_L,S_WALL2,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_GUN_U,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_GUN_U,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_WALL2,S_WALL_H2,S_WALL_H2,S_WALL,S_DIRT,S_DIRT,S_WALL,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_PIPE_HS,S_WALL,S_PIPE_HS,S_PIPE_HS,S_PIPE_HS,S_PIPE_HS,S_PIPE_HE,S_PIPE_H1,S_PIPE_BL,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_GUN_L,S_PIPE_HS,S_PIPE_HE,S_PIPE_HE,S_PIPE_HE,S_PIPE_HE,S_PIPE_HE,S_PIPE_HE,S_PIPE_BL,S_DIRT2,S_DIRT,S_DIRT,S_DIRT2,S_DIRT,S_DIRT,S_DIRT,S_DIRT2,S_DIRT,S_DIRT,S_DIRT,S_DIRT,S_DIRT2,S_DIRT,S_DIRT,S_PIPE_BR,S_PIPE_HE,S_PIPE_HE,S_PIPE_HE,S_PIPE_HS,S_PIPE_HE,S_PIPE_HS,S_PIPE_HE,S_PIPE_HE,S_PIPE_HE,S_PIPE_HS,S_PIPE_HE,S_PIPE_HS,S_PIPE_HS,S_PIPE_BL,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_WALL,S_FLOOR,S_WALL,S_FLOOR,S_WALL,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR,S_FLOOR},
...
void initialize_world() {
    ...
    add_thing(KIND_LEVER,58,10,DIR_L,DIR_C,0,0,250); //// FOR MUSIC!!!

    add_thing(KIND_BARELL,21,4,DIR_C,DIR_C,0,0,0); //// object #0
    add_thing(KIND_BARELL,24,6,DIR_C,DIR_C,0,0,0); //// object #1
    add_thing(KIND_BARELL,2,8,DIR_C,DIR_C,0,0,0); //// object #2
    add_thing(KIND_BARELL,4,9,DIR_C,DIR_C,0,0,0); //// object #3
    add_thing(KIND_BARELL,0,11,DIR_C,DIR_C,0,0,0); //// object #4
    add_thing(KIND_BARELL,1,11,DIR_C,DIR_C,0,0,0); //// object #5
    add_thing(KIND_BARELL,21,12,DIR_C,DIR_C,0,0,0); //// object #6
    add_thing(KIND_BARELL,106,10,DIR_C,DIR_C,0,0,0); //// object #7
    add_thing(KIND_BARELL,107,9,DIR_C,DIR_C,0,0,0); //// object #8
    add_thing(KIND_BARELL,108,11,DIR_C,DIR_C,0,0,0); //// object #9
    add_thing(KIND_BARELL,110,11,DIR_C,DIR_C,0,0,0); //// object #10
    add_thing(KIND_BARELL,112,12,DIR_C,DIR_C,0,0,0); //// object #11
    add_thing(KIND_BARELL,112,11,DIR_C,DIR_C,0,0,0); //// object #12
    add_thing(KIND_BARELL,112,9,DIR_C,DIR_C,0,0,0); //// object #13
    add_thing(KIND_BARELL,111,12,DIR_C,DIR_C,0,0,0); //// object #14
    add_thing(KIND_BOMB,125,8,DIR_C,DIR_C,0,0,0); //// object #15
    add_thing(KIND_GUN,23,1,DIR_U,DIR_C,2,5,0); //// object #16
    add_thing(KIND_GUN,25,1,DIR_U,DIR_C,2,5,0); //// object #17
    add_thing(KIND_GUN,27,1,DIR_U,DIR_C,2,5,0); //// object #18
    add_thing(KIND_BARELL,61,7,DIR_C,DIR_C,0,0,0); //// object #19
    add_thing(KIND_BARELL,62,6,DIR_C,DIR_C,0,0,0); //// object #20
    add_thing(KIND_BARELL,62,7,DIR_C,DIR_C,0,0,0); //// object #21
    add_thing(KIND_BARELL,68,11,DIR_C,DIR_C,0,0,0); //// object #22
    add_thing(KIND_BARELL,18,21,DIR_C,DIR_C,0,0,0); //// object #23
    add_thing(KIND_GUN,58,1,DIR_U,DIR_C,2,5,0); //// object #24
    add_thing(KIND_GUN,58,5,DIR_D,DIR_C,1,5,0); //// object #25
    add_thing(KIND_GUN,57,2,DIR_L,DIR_C,3,5,0); //// object #26
    add_thing(KIND_GUN,57,3,DIR_L,DIR_C,4,5,0); //// object #27
    add_thing(KIND_GUN,57,4,DIR_L,DIR_C,5,5,0); //// object #28
    add_thing(KIND_GUN,59,2,DIR_R,DIR_C,3,5,0); //// object #29
    add_thing(KIND_GUN,59,3,DIR_R,DIR_C,4,5,0); //// object #30
    add_thing(KIND_GUN,59,4,DIR_R,DIR_C,5,5,0); //// object #31
    add_thing(KIND_BARELL,107,29,DIR_C,DIR_C,0,0,0); //// object #32
    add_thing(KIND_BARELL,104,30,DIR_C,DIR_C,0,0,0); //// object #33
    add_thing(KIND_BARELL,105,31,DIR_C,DIR_C,0,0,0); //// object #34
    add_thing(KIND_GUN,1,23,DIR_L,DIR_C,4,5,0); //// object #35
    add_thing(KIND_GUN,3,21,DIR_R,DIR_C,2,5,0); //// object #36
    add_thing(KIND_BARELL,7,20,DIR_C,DIR_C,0,0,0); //// object #37
    add_thing(KIND_GUN,3,23,DIR_R,DIR_C,4,5,0); //// object #38
    add_thing(KIND_GUN,49,14,DIR_D,DIR_C,5,5,0); //// object #39
    add_thing(KIND_GUN,51,14,DIR_D,DIR_C,5,5,0); //// object #40
    add_thing(KIND_GUN,52,14,DIR_D,DIR_C,5,5,0); //// object #41
    add_thing(KIND_BARELL,110,10,DIR_C,DIR_C,0,0,0); //// object #42
    add_thing(KIND_DOOR,65,13,DIR_C,DIR_C,0,0,0); //// object #44
    add_thing(KIND_DOOR,59,13,DIR_C,DIR_C,0,0,0); //// object #45
    add_thing(KIND_DOOR,62,26,DIR_C,DIR_C,0,0,0); //// object #46
    add_thing(KIND_DOOR,82,28,DIR_C,DIR_C,0,0,0); //// object #47
    add_thing(KIND_DOOR,95,26,DIR_C,DIR_C,0,0,0); //// object #48
    add_thing(KIND_DOOR,87,13,DIR_C,DIR_C,0,0,0); //// object #49
    add_thing(KIND_DOOR,104,13,DIR_C,DIR_C,0,0,0); //// object #50
    add_thing(KIND_DOOR,104,6,DIR_C,DIR_C,0,0,0); //// object #51
    add_thing(KIND_DOOR,117,13,DIR_C,DIR_C,0,0,0); //// object #52
    add_thing(KIND_DOOR,6,13,DIR_C,DIR_C,0,0,0); //// object #53
    add_thing(KIND_DOOR,26,17,DIR_C,DIR_C,0,0,0); //// object #54
    add_thing(KIND_DOOR,30,17,DIR_C,DIR_C,0,0,0); //// object #55
    add_thing(KIND_DOOR,34,17,DIR_C,DIR_C,0,0,0); //// object #56
    add_thing(KIND_DOOR,38,17,DIR_C,DIR_C,0,0,0); //// object #57
    add_thing(KIND_DOOR,26,21,DIR_C,DIR_C,0,0,0); //// object #58
    add_thing(KIND_DOOR,23,26,DIR_C,DIR_C,0,0,0); //// object #59
    add_thing(KIND_DOOR,47,31,DIR_C,DIR_C,0,0,0); //// object #60
    add_thing(KIND_DOOR,1,28,DIR_C,DIR_C,0,0,0); //// object #61
    add_thing(KIND_DOOR,7,26,DIR_C,DIR_C,0,0,0); //// object #62
    add_thing(KIND_DOOR,70,13,DIR_C,DIR_C,0,0,0); //// object #63
    add_thing(KIND_DOOR,67,29,DIR_C,DIR_C,0,0,0); //// object #64
    add_thing(KIND_DOOR,16,23,DIR_C,DIR_C,0,0,0); //// object #65
    add_thing(KIND_DOOR,84,26,DIR_C,DIR_C,0,0,0); //// object #66
    add_thing(KIND_DOOR,101,25,DIR_C,DIR_C,0,0,0); //// object #67
    add_thing(KIND_ELECTRIC,18,13,DIR_L,DIR_C,0,0,0); //// object #68
    add_thing(KIND_OXYGEN,3,9,DIR_C,DIR_C,0,0,0); //// object #69
    add_thing(KIND_OXYGEN,2,9,DIR_C,DIR_C,0,0,0); //// object #70
    add_thing(KIND_OXYGEN,106,12,DIR_C,DIR_C,0,0,0); //// object #71
    add_thing(KIND_CRYSTAL,50,3,DIR_C,DIR_C,0,0,0); //// object #72
    add_thing(KIND_MIRROR,91,19,DIR_C,DIR_C,0,0,0); //// object #73
    add_thing(KIND_OXYGEN,66,8,DIR_C,DIR_C,0,0,0); //// object #74
    add_thing(KIND_OXYGEN,48,29,DIR_C,DIR_C,0,0,0); //// object #75
    add_thing(KIND_CRYSTAL,121,31,DIR_C,DIR_C,0,0,0); //// object #76
    add_thing(KIND_CRYSTAL,119,31,DIR_C,DIR_C,0,0,0); //// object #77
    add_thing(KIND_BARELL,55,0,DIR_C,DIR_C,0,0,0); //// object #78
    add_thing(KIND_BIGBATON,79,8,DIR_C,DIR_C,0,0,0); //// object #79
    add_thing(KIND_TENTACLES,78,11,DIR_D,DIR_C,0,0,0); //// object #80
    add_thing(KIND_TENTACLES,80,11,DIR_D,DIR_C,0,0,0); //// object #81
    add_thing(KIND_TENTACLES,78,9,DIR_U,DIR_C,0,0,0); //// object #82
    add_thing(KIND_TENTACLES,80,9,DIR_U,DIR_C,0,0,0); //// object #83
    add_thing(KIND_TENTACLES,46,18,DIR_L,DIR_C,0,0,0); //// object #84
    add_thing(KIND_TENTACLES,46,20,DIR_L,DIR_C,0,0,0); //// object #85
    add_thing(KIND_TENTACLES,34,0,DIR_U,DIR_C,0,0,0); //// object #86
    add_thing(KIND_TENTACLES,34,31,DIR_D,DIR_C,0,0,0); //// object #87
    add_thing(KIND_TENTACLES,34,6,DIR_D,DIR_C,0,0,0); //// object #88
    add_thing(KIND_TENTACLES,16,17,DIR_L,DIR_C,0,0,0); //// object #89
    add_thing(KIND_TENTACLES,41,20,DIR_R,DIR_C,0,0,0); //// object #90
    add_thing(KIND_TENTACLES,41,18,DIR_R,DIR_C,0,0,0); //// object #91
    add_thing(KIND_BOMB,52,20,DIR_C,DIR_C,0,0,0); //// object #92
    add_thing(KIND_OXYGEN,35,19,DIR_C,DIR_C,0,0,0); //// object #93
    add_thing(KIND_OXYGEN,33,20,DIR_C,DIR_C,0,0,0); //// object #94
    add_thing(KIND_TENTACLES,41,19,DIR_R,DIR_C,0,0,0); //// object #95
    add_thing(KIND_TENTACLES,46,19,DIR_L,DIR_C,0,0,0); //// object #96
    add_thing(KIND_TENTACLES,39,18,DIR_L,DIR_C,0,0,0); //// object #97
    add_thing(KIND_TENTACLES,39,19,DIR_L,DIR_C,0,0,0); //// object #98
    add_thing(KIND_TENTACLES,39,20,DIR_L,DIR_C,0,0,0); //// object #99
    add_thing(KIND_TENTACLES,38,20,DIR_U,DIR_C,0,0,0); //// object #100
    add_thing(KIND_TENTACLES,37,20,DIR_R,DIR_C,0,0,0); //// object #101
    add_thing(KIND_TENTACLES,37,19,DIR_R,DIR_C,0,0,0); //// object #102
    add_thing(KIND_TENTACLES,37,18,DIR_D,DIR_C,0,0,0); //// object #103
    add_thing(KIND_OXYGEN,68,25,DIR_C,DIR_C,0,0,0); //// object #104
    add_thing(KIND_LEVER,68,12,DIR_L,DIR_C,0,0,1); //// object #105
    add_thing(KIND_ELECTRIC,69,19,DIR_U,DIR_C,0,0,1); //// object #106
    add_thing(KIND_ELECTRIC,69,18,DIR_U,DIR_C,0,0,1); //// object #107
    add_thing(KIND_ELECTRIC,71,18,DIR_U,DIR_C,0,0,1); //// object #108
    add_thing(KIND_ELECTRIC,71,19,DIR_U,DIR_C,0,0,1); //// object #109
    add_thing(KIND_LEVER,38,19,DIR_L,DIR_C,0,0,2); //// object #110
    add_thing(KIND_ELECTRIC,45,5,DIR_L,DIR_C,0,0,2); //// object #111
    add_thing(KIND_ELECTRIC,44,5,DIR_L,DIR_C,0,0,2); //// object #112
    add_thing(KIND_ELECTRIC,43,5,DIR_L,DIR_C,0,0,2); //// object #113
    add_thing(KIND_ELECTRIC,42,5,DIR_L,DIR_C,0,0,2); //// object #114
    add_thing(KIND_ELECTRIC,45,7,DIR_L,DIR_C,0,0,2); //// object #115
    add_thing(KIND_ELECTRIC,44,7,DIR_L,DIR_C,0,0,2); //// object #116
    add_thing(KIND_ELECTRIC,43,7,DIR_L,DIR_C,0,0,2); //// object #117
    add_thing(KIND_ELECTRIC,42,7,DIR_L,DIR_C,0,0,2); //// object #118
    add_thing(KIND_ELECTRIC,45,9,DIR_L,DIR_C,0,0,2); //// object #119
    add_thing(KIND_ELECTRIC,44,9,DIR_L,DIR_C,0,0,2); //// object #120
    add_thing(KIND_ELECTRIC,43,9,DIR_L,DIR_C,0,0,2); //// object #121
    add_thing(KIND_ELECTRIC,42,9,DIR_L,DIR_C,0,0,2); //// object #122
    add_thing(KIND_ROBOT,89,22,DIR_R,DIR_C,0,0,3); //// object #123
    add_thing(KIND_JOYSTICK,86,23,DIR_C,DIR_C,0,0,3); //// object #124
    add_thing(KIND_ELECTRIC,87,24,DIR_L,DIR_C,0,0,4); //// object #125
    add_thing(KIND_ELECTRIC,86,24,DIR_L,DIR_C,0,0,4); //// object #126
    add_thing(KIND_ELECTRIC,85,24,DIR_L,DIR_C,0,0,4); //// object #127
    add_thing(KIND_LEVER,99,25,DIR_L,DIR_C,0,0,4); //// object #128
    add_thing(KIND_BOMB,26,19,DIR_C,DIR_C,0,0,5); //// object #129
    add_thing(KIND_DETONATOR_0,30,19,DIR_C,DIR_C,0,0,5); //// object #130
    add_thing(KIND_DETONATOR_0,114,9,DIR_C,DIR_C,0,0,6); //// object #131
    add_thing(KIND_BOMB,111,10,DIR_C,DIR_C,0,0,6); //// object #132
    add_thing(KIND_BOMB,107,11,DIR_C,DIR_C,0,0,6); //// object #133
    add_thing(KIND_ROBOT,14,0,DIR_U,DIR_C,0,0,7); //// object #134
    add_thing(KIND_JOYSTICK,23,4,DIR_C,DIR_C,0,0,7); //// object #135
    add_thing(KIND_LEVER,6,7,DIR_R,DIR_C,0,0,8); //// object #136
    add_thing(KIND_GUN,5,5,DIR_L,DIR_C,1,5,8); //// object #137
    add_thing(KIND_GUN,5,3,DIR_L,DIR_C,4,5,8); //// object #138
    add_thing(KIND_GUN,7,3,DIR_R,DIR_C,4,5,8); //// object #139
    add_thing(KIND_LEVER,36,0,DIR_L,DIR_C,0,0,9); //// object #140
    add_thing(KIND_ELECTRIC,35,27,DIR_U,DIR_C,0,0,9); //// object #141
    add_thing(KIND_ELECTRIC,22,27,DIR_U,DIR_C,0,0,9); //// object #142
    add_thing(KIND_CORKSCREW,22,20,DIR_C,DIR_C,0,0,10); //// object #143
    add_thing(KIND_TENTACLES,22,24,DIR_D,DIR_C,0,0,10); //// object #144
    add_thing(KIND_TENTACLES,22,25,DIR_U,DIR_C,0,0,10); //// object #145
    add_thing(KIND_ELECTRIC,28,23,DIR_U,DIR_C,0,0,9); //// object #146
    add_thing(KIND_ELECTRIC,28,22,DIR_U,DIR_C,0,0,9); //// object #147
}
...
void toggle_all_electrics_with_label(uint8_t label) {
    ...
    for(t=0;t<=last_occupied;t++) {
        ...
        switch(things[t].kind) {
            case KIND_ELECTRIC: things[t].kind=KIND_ELECTRIC_OFF; break;
            case KIND_ELECTRIC_OFF: things[t].kind=KIND_ELECTRIC; break;
